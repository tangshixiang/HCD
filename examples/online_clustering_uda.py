...
from examples.hierarchy_gcn import Hierarchy_GCN,Utils,p_gcn,s_gcn,c_gcn,split_gcn
...
def main_worker(args):
    ...
    Split_GCN=split_gcn(2048,2048,source_classes,source_classes)
    hier_gcn=Hierarchy_GCN(P_GCN,S_GCN,C_GCN,Split_GCN,uti,r=args.gcn_r,point_add_dyn_thre=args.gcn_point_add_dyn_thre,
    ...
    optimizer_gcn=[optimizer_p_gcn,optimizer_s_gcn,optimizer_c_gcn,optimizer_split_gcn]
    lr_gcn=[lr_p_gcn,lr_s_gcn,lr_c_gcn,lr_split_gcn]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--inference-thre', type=float, nargs='+',default=[0.6,0.6,0.5,0.5])
